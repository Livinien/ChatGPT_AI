<section id="inputSection" class="col-11 col-md-10 col-xl-7 d-flex align-items-center justify-content-end flex-column mx-auto">
    <form id="inputContainer" class="d-flex align-self-center justify-content-between col-12 border-0 rounded-3 bg-secondary-subtle shadow bs-1 p-1 mx-2 mx-sm-0">
